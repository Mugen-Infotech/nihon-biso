...
const tipCategories = [
  {
    ...
    icon: FileText,
    href: "/tips/classification",
  },
  {
    title: "一般廃棄物と産業廃棄物",
    description: "一般廃棄物と産業廃棄物の違いについて説明します",
    icon: Recycle,
    href: "/tips/waste-types",
  },
  {
    title: "処理委託契約とは？",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <PageHeader
        title="ヒント一覧"
        subtitle="Tips"
        imageUrl="https://sjc.microlink.io/9O07nMGMyb8dsDeJSDrvSqjdMQu4h8XnDfyyGOZ7KBpbfBZMY2fYl-nGEm64JE1IZDYeFsdrUQzdX7AToW3gYg.jpeg"
      />
